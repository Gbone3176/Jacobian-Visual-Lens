...
Colorectal/endoscopy polyp example using an attribute prompt, layer16, prefix_n50 JLens, a VG-style 24x24 raw attention map, raw_attention-ranked patches, and independent patch blocks with no interpolation.
